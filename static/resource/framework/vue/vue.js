  ...
  addHandler(el, 'change',
    ...
    'if(Array.isArray($$a)){' +
      "var $$v=" + (number ? '_n(' + valueBinding + ')' : valueBinding) + "," +
          '$$i=_i($$a,$$v);' +
      "if($$el.checked){$$i<0&&(" +="" value="" "="$$a.concat([$$v]))}"" "else{$$i="">-1&&(" + value + "=$$a.slice(0,$$i).concat($$a.slice($$i+1)))}" +
...
</body></html></div></a></"></"></div></div></template></"></template></slot></"></template></"></"></"></',></\\></"></div></div></div></div></"></transition-group></transition></transition-group></transition></keep-alive></select></transition></transition></transition></transition></transition></=></0&&("></"></"></iframe></tbody></p></=></=></=></slot></slot></template></vnode></anonymous></"></root>